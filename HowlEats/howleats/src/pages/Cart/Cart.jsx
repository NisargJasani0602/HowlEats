  ...
  return (
    ...
    <div className="row">
                                ...
                                return (
                                  <div key={food.id} className="row cart-item mb-3">
                                    <div className="col-md-3">
                                      <img src={food.imageUrl || food.imageURL} alt={food.name} className="img-fluid rounded" />
                                    </div>
                                    ...
                                    <div className="col-md-2">
                                      <div className="input-group">
                                        ...
                                        <input style={{ maxWidth: '100px' }} type="text" className="form-control form-control-sm text-center quantity-input" value={count} readOnly />
                                        <button className="btn btn-outline-secondary btn-sm" type="button" onClick={() => increaseQty(food.id)}>+</button>
                                      </div>
                                    </div>
                                    <div className="col-md-2 text-end">
                                      <p className="fw-bold">${(food.price * count).toFixed(2)}</p>
        ...
        <div className="col-lg-4">
            <div className="card cart-summary  p-4 shadow-sm">
                <div className="card-body">
